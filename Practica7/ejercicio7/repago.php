...
<html>
    ...
    <body>
        ...
        <form action="https://www.paypal.com/cgi-bin/webscr" name="f1" id="f1" method="post">
            ...
            <imgsrc="https://www.paypal.com/en_US/i/bnr/horizontal_solution_PP.gif" alt="Solution Graphics" border="0" align="absmiddle"></a></legend>
            ...
            <tr>
                ...
                <span class="prod"><strong>Detalle de los Productos Seleccionados</strong>:
                </span>
                <br>
                <span class="texto1negro"> 
                </span>
