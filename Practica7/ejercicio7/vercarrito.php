    ...
    <body>
        ...
        $suma=0;
            foreach($carro as $k => $v){
                ...
                $contador++;
         ?> 
          <form name="a<?php echo $v['identificador'] ?>" method="post"action="agregacar.php?
          <?php echo SID ?>" id="a<?php echo $v['identificador'] ?>">
        ...
        <?php }?>
            ...
            <div align="center"><span class="prod">Continuar la selección de productos</span>
             ...
             /* para pagar comentado*/
             <img src="finalizarcompra.gif" width="135" height="16" border="0" align="absmiddle"></a>
            </div>    
            <?php }else{ ?>
